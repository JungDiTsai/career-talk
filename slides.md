...
<div class="w-full px-7 py-5 h-full grid grid-cols-[1.15fr_1fr] gap-4 items-start mx-auto max-h-full">
  ...
  <div class="h-full flex items-center justify-center overflow-hidden">
    <img src="./images/AVATAR.JPG" class="rounded-2xl shadow-2xl max-h-full h-auto w-auto object-contain" alt="蔡仲迪" />
  </div>
</div>
...
<div class="mt-4 grid grid-cols-[1.05fr_1fr] gap-6 items-start h-85%">
  ...
  <img
      v-show="$clicks <= 1"
      src="./images/NUUEE.jpg"
      alt="電子工程系"
      class="absolute inset-0 h-full w-full object-cover"
    />
    <img
      v-show="$clicks === 2"
      src="./images/CONSTRUCTION_PLANT.jpg"
      alt="在工地工作的時期"
      class="absolute inset-0 h-full w-full object-cover"
    />
    <img
    ...
    <img
      v-show="$clicks === 4"
      src="./images/CONVENIENCE_STORE.jpg"
      alt="便利商店"
      class="absolute inset-0 h-full w-full object-cover"
    />
    <img
...
Click
當退學通知書寄到家裡來的那一天，就像是被判刑定讞一樣。我與家庭關係撕裂了。
我不曾看到我那超級Tough的老爸哭過，那是唯一一次。
我哭著跟我爸我媽道歉，跟他們說接下來我會自己一個人負責。

Click Click
從南投的工地工作，再到台中的餐廳、超商打工，也當過一陣子的家教，大概半年的期間我都不敢和家裡的人聯絡。

直到有一天，我爸打給我，那時候我還在猶豫要不要把電話接起來，因為我不知道電話接起來的之後要說些什麼。
但最後還是接起來了，電話一開頭，我聽著我爸帶著一點酒醉的聲音說
「弟弟」你很久沒有沒有回家了捏，爸爸很想你。
也正是因為那一天的電話，把我接住了。我也沒想過我那Tough的老爸，會對我說出這樣的話，那一刻的我得到了救贖。

這也是我會想念心理學系的開始。

從我的脫軌到與父親關係的轉變，我開始對於自己身上的議題感到興趣。

Click 
我所遇到的挫折與問題可能跟環境、期待、策略、支持系統有關。
...
<div class="mt-4 grid grid-cols-[1.05fr_1fr] gap-6 items-start h-85%">
  ...
  <div class="relative h-full rounded-2xl overflow-hidden shadow-xl border border-white/60 bg-white/50">
    ...
    <img
      v-show="$clicks === 1"
      src="./images/JU_SISTER.jpg"
      alt="小珠姊"
      class="absolute inset-0 h-full w-full object-contain"
    />
    <img
      v-show="$clicks === 2"
      src="./images/DINGALAW.jpg"
      alt="頂阿陋"
      class="absolute inset-0 h-full w-full object-contain"
    />
    <img
      v-show="$clicks === 3"
      src="./images/DONG_SISTER.jpg"
      alt="董姊"
      class="absolute inset-0 h-full w-full object-contain"
    />
    <img
      v-show="$clicks >= 4"
      src="./images/LIN_MAMA.jpg"
      alt="林媽媽"
      class="absolute inset-0 h-full w-full object-contain"
    />
  </div>
...
<!--
第一次的脫軌之後，我便開始準備起了心理學系的轉學考。

第一次的轉學考的結果我並沒有考上任何一間學校，也因為沒有在學的關係，接受到兵單的我就去當兵了。

退伍之後我面臨了
1. 第一個現實問題，我已經21歲了，還能在考幾次。
2. 心理學系報考的人數與錄取的名額差異很大，我沒有記錯的話我那一屆輔大心理系轉學考試149人錄取5個。

再考不上，怎麼辦 ?

我還要再繼續念書嗎 ? 在當下我的根本就沒有答案，只能硬著頭皮再考一次了。

在第二次準備轉學考的過程當中，我回到了入伍當兵前的超商繼續工作。

Click
跟客人們也越來越熟，我也開始願意分享自己正在準備心理學系的轉學考，當然還有我的徬徨。

但也或許也正是我開始願意述說，我遇到了許多改變了我人生中的貴人，譬如說畫面上(左2)的小珠姊。

Click
在等待第二次轉學考錄取名單出來的時候，小珠姊問我要不要去她的部落走走。
Click
那這張圖片是在花蓮豐濱鄉的聚會所叫做「頂阿陋」，印象最深刻的是我和身邊的部落朋友們手牽手閉眼睛一起禱告，禱告結束之後我們席地而坐一起吃飯，旁邊的一位部落阿嬤問我是誰，這時候小珠姊說我是他的娃娃。這時候我震驚也很感動的，對於我一個外來的人說，我在部落裡面被接起來了，他們沒有管我是誰，不問我在做什麼，我都是他們的娃娃，那時候我在部落很真實的感受到溫暖還有人與人的連結與支持。

Click
還有一位董姊，那時候跟我說，如果你沒考上的話，如果想學一技之長，可以和她說。她們打算在彰化有開一間日式料理店，可以在她老公旁邊學習，或許在沒考上心理學系之後，我現在會是日本料理師傅。

Click
還有最後在我考上之後，祝賀給我紅包的林媽媽。

我想和大家說的是，在過程當中，不是所有的問題都能在當下得到解答。
有時候必須等待，選擇變得越來越清晰。
-->
...
<div class="mt-4 grid grid-cols-[1.05fr_1fr] gap-6 items-start h-85%">
  ...
  <img
    v-show="$clicks === 1"
    src="./images/EXPLORE_1.jpg"
    alt="青少年發展署"
    class="absolute inset-0 h-full w-full object-cover"
  />
  <img
    v-show="$clicks === 2"
    src="./images/EXPLOER_2.jpeg"
    alt="暑期工讀"
    class="absolute inset-0 h-full w-full object-cover"
  />
  <img
    v-show="$clicks === 3"
    src="./images/FJU_WEB.jpg"
    alt="通識課"
    class="absolute inset-0 h-full w-full object-cover"
  />
  <img
    v-show="$clicks >= 4"
    src="./images/CONSAULTANT.jpg"
    alt="學生輔導中心-工讀生"
    class="absolute inset-0 h-full w-full object-contain"
  />
...
<!--
回頭看我的大學生活，
我覺得有很多後來派上用場的能力，但一開始都不是用職涯規劃的方式出現的。
...
但後來我發現，影片剪輯不只是要會操作軟體。
它也包含怎麼整理素材、怎麼樣去說故事，怎麼樣可以吊人胃口，吸引你的眼光繼續看下去。

Click Click
有意思的是，後來我能夠面試上青年發展署的社區工讀，影片剪輯就是一個很加分的原因。
本來只是有興趣的東西，有時候會在某個機會裡，突然變成你的優勢。

Click
我也修過網頁設計的通識課。
那時候它看起來不是我現在職涯的主線，只是一堂選修課。
我可以透過 HTML、CSS，把內容放到網路上。
可以調整版面，可以做出互動，可以把一個想法變成使用者看得見的東西。
對後來的我來說，這其實是走向工程師很早期的線索。

Click
另外，我也在學生輔導中心當過工讀生。
這讓心理學不只是課本裡的理論，而是讓我真的看見人會有壓力、會迷惘、會需要支持，也會需要被理解。

我也看到就算是諮商師，也會有焦慮跟慌恐出現。

這些經驗當下看起來可能很零散。好像都不是同一條線上。

但回頭看，它們其實慢慢接起來了。

影片剪輯讓我練習用畫面說故事。

網頁設計讓我有機會認識程式碼的世界其實和我們一般人沒有那麼遠，(但更多是前端工程師)。

學生輔導中心讓我更理解人，也理解更多的自己。

青年發展署的社區工讀，也讓我初步認識非營利組織是在做什麼。|
...
帶著助人的使命感，與非營利組織暑期工讀的經驗。
我進入第一份工作。

我那時候服務的對象是街友、單親媽媽。
工作接觸的事情很多，有募款、輔導、工作媒合、愛心餐，尋找街友的住宿。

這些事情聽起來都很有意義。
但真正進到現場之後，我才知道，有意義的工作不代表不會累。
1.我得要募得一筆不小的款項、還有物資作為我的KPI
2.我得解決街友紛爭 (偷東西、打架、找工作)
3.準備餐食

還有他們是真實的人、有真實的需求、有真實的限制。

那時候我開始理解，從學生變成工作者，不只是換一個身份。
它是一整套生活節奏跟責任感還有人際關係與自我定位的改變。

Click
第一份工作裡，漫長的工時也讓我印象很深。

Click
因為南投要設立第一個平安站，所以什麼資源都沒有。我得學習工作內容，天天必須彰化和南投兩邊跑。
我得募款、我的準備便當、單據的開立，時間根本就不夠，我記得我好像早上7點出門，但我回家也是晚上七點。
然後還得準備要拜訪的名單、愛心商家。
...
<!--
Bug #2 之後，我跑去做除草。
這是一個朋友的友善農地，我從第一份工作離職的時候，剛好遇到繁忙的季節(夏天，雜草長很快)人手也不夠，剛好我又是一個閒置人力，就被邀請過去幫忙了。
...
<!--
在當農工那段沉澱之後，我開始更務實地思考自己的下一步。

我也開始問自己，什麼能力可以長期累積？
什麼工作有比較好的收入成長？
什麼職業可以讓我未來有更多選擇？
如果我想成為家裡比較穩定的支柱，我需要培養什麼能力？

那個時候，因為Web和APP的發展速度很快，讓我看到我好像可以嘗試看看，因為在大學通識課的經驗，我其實並不排斥。

Click
軟體工作吸引我的地方之一，是它讓我看到遠端辦公和跨國工作的可能。
如果你的能力可以透過網路交付，如果你的產出可以透過程式碼、系統和協作工具被看見，那工作就不一定完全被地點限制。
Click
資源限制也少，我只要有一台電腦就可以工作。
Click
有機會可以到其他國家工作
Click
當然工程師的收入相較之前的工作是更多的
...
又再次我把前面那些迷惘、挫折、現實壓力和未來想像，整理成一個具體行動。
...
<!--
很多人後來聽到我從心理系轉到前端工程，可能會覺得這是一個很漂亮的故事。
...
<!--
剛剛有說到心理系給我的理解人的能力，我用自己的方式重新走回工程。
